...
TOP19 | sdc/HolidayMode_State | Holiday mode (0=off, 1=on)
...
TOP25 | sdc/DHW_Shift_Temp | Shift DHW temperature (-12 to -2)
TOP26 | sdc/Defrosting_State | Defrost state (0=off, 1=on)
TOP27 | sdc/Z1_HeatRequest_Temp | Zone 1 Heat Requested shift temp (-5 to 5) or direct heat temp (20 to max)
TOP28 | sdc/Z1_CoolRequest_Temp | Zone 1 Cool Requested shift temp (-5 to 5) or direct cool temp (5 to 20)
TOP29 | sdc/HCurve_OutHighTemp | Target temperature at lowest point on the heating curve (°C)
TOP30 | sdc/HCurve_OutLowTemp | Target temperature at highest point on the heating curve (°C)
TOP31 | sdc/HCurve_OutsHighTemp | Lowest outside temperature on the heating curve (°C)
TOP32 | sdc/HCurve_OutsLowTemp | Highest outside temperature on the heating curve (°C)
TOP33 | sdc/RoomThermostat_Temp | Remote control thermostat temp (°C)
TOP34 | sdc/Z2_HeatRequest_Temp | Zone 2 Heat Requested shift temp (-5 to 5) or direct heat temp (20 to max)
TOP35 | sdc/Z2_CoolRequest_Temp | Zone 2 Cool Requested shift temp (-5 to 5) or direct cool temp (5 to 20)
...
TOP45 | sdc/Holiday_Shift_Temp | Shift holiday temperature (-15 to 15)
...
TOP72 | sdc/CCurve_OutHighTemp | Target temperature at lowest point on the cooling curve (°C)
