...
TOP29 | sdc/Heat_Curve_Target_High_Temp | Target temperature at lowest point on the heating curve (°C)
TOP30 | sdc/Heat_Curve_Target_Low_Temp | Target temperature at highest point on the heating curve (°C)
TOP31 | sdc/Heat_Curve_Outside_High_Temp | Lowest outside temperature on the heating curve (°C)
TOP32 | sdc/Heat_Curve_Outside_Low_Temp | Highest outside temperature on the heating curve (°C)
...
TOP72 | sdc/Cool_Curve_Target_High_Temp | Target temperature at lowest point on the cooling curve (°C)
TOP73 | sdc/Cool_Curve_Target_Low_Temp | Target temperature at highest point on the cooling curve (°C)
TOP74 | sdc/Cool_Curve_Outside_High_Temp | Lowest outside temperature on the cooling curve (°C)
TOP75 | sdc/Cool_Curve_Outside_Low_Temp | Highest outside temperature on the cooling curve (°C)
