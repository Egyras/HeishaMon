...
class OpenTherm
{
  public:
    ...
    //smartpower
    void setSmartPower(bool state);
    bool smartPowerEnabled;
    volatile OpenThermSmartPower smartPowerState;
  ...
  private:
    ...
    bool logicalReceiveHigh = HIGH;
    bool logicalSendHigh = HIGH;
