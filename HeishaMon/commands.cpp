...
const char* mqtt_set_power_state_topic = "panasonic_heat_pump/SetPower";
...
void send_heatpump_command(char* topic, char msg[],bool (*send_command)(byte*, int),void (*log_message)(char*)){
  ...
  // set powerstate to on by sending 1
  if (strcmp(topic, mqtt_set_power_state_topic) == 0)
  {
    String set_power_state_string(msg);
    byte power_state = 1;
    if ( set_power_state_string.toInt() == 1 ) {
      power_state = 2; 
    }
    sprintf(log_msg, "set power state to %d", power_state); log_message(log_msg);
    byte command[] = {0xf1, 0x6c, 0x01, 0x10, power_state, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
