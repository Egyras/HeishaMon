...
unsigned int set_max_pump_duty(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set max pump duty to %d", pumpduty - 1);
    memcpy(log_msg, tmp, sizeof(tmp));
  }

  {
    unsigned char tmp[] = {0xf1, 0x6c, 0x01, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, pumpduty, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
unsigned int set_zones(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set zones active state to %d", set_mode);
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_floor_cool_delta(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set floor cool delta to %d", request_temp - 128 );
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_reset(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set reset to %d", resetRequest);
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_heater_delay_time(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set heater delay time to %d", byteValue - 1 );
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_heater_start_delta(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set heater start delta to %d", byteValue - 128 );
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_heater_stop_delta(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set heater stop delta to %d", byteValue - 128 );
    memcpy(log_msg, tmp, sizeof(tmp));
  }
...
unsigned int set_main_schedule(char *msg, unsigned char *cmd, char *log_msg) {
  ...
  {
    char tmp[256] = { 0 };
    snprintf(tmp, 255, "set main schedule to %d", byteValue);
    memcpy(log_msg, tmp, sizeof(tmp));
  }
