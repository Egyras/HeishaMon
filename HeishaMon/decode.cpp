...
void decode_heatpump_data(char* data, DynamicJsonDocument &actData, PubSubClient &mqtt_client, void (*log_message)(char*)) {
  ...
  int topicsrun[] = {0, 3, 4, 18, 17, 20, 26, 9, 6, 8, 10, 13, 14, 5, 36, 37, 7, 33, 21, 27, 28, 29, 30, 31, 32, 33, 34, 2, 19, 15, 16, 22, 23, 24, 38, 39, 40, 41, 42, 43, 45, 25}; // which topics are already working with new style
