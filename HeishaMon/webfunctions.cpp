...
void handleRoot(ESP8266WebServer *httpServer, DynamicJsonDocument *actData) {
  httpServer->setContentLength(CONTENT_LENGTH_UNKNOWN); // *** BEGIN ***
