...
static const char *Model[] PROGMEM = {
  ...
  "IDU: WH-SDC0309K3E5, ODU: WH-UDZ07KE5", //38
  "IDU: WH-ADC0916H9E8, ODU: WH-UX16HE8", //39
  "IDU: WH-ADC0912H9E8, ODU: WH-UX12HE8", //40
  "IDU: WH-SDC12H9E8, ODU: WH-UD12HE8", //41
  "WH-MXC16J9E8", //42
};
...
static const byte knownModels[sizeof(Model) / sizeof(Model[0])][10] PROGMEM = { //stores the bytes #129 to #138 of known models in the same order as the const above
  ...
  0xE2, 0xD5, 0x0B, 0x08, 0x95, 0x02, 0xD6, 0x0E, 0x67, 0x95, //38
  0xE2, 0xCF, 0x0C, 0x74, 0x09, 0x12, 0xD0, 0x0C, 0x96, 0x05, //39
  0xE2, 0xCF, 0x0C, 0x74, 0x09, 0x12, 0xD0, 0x0E, 0x95, 0x05, //40
  0xE2, 0xCF, 0x0C, 0x89, 0x05, 0x12, 0xD0, 0x0C, 0x98, 0x05, //41
  0x32, 0xD4, 0x0B, 0x89, 0x84, 0x73, 0x90, 0x0C, 0x86, 0x84, //42
};
